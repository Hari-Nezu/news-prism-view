...
export default function RankingMediumCard({
  ...
  return (
    ...
    >
      ...
      >
        <span className="w-6 h-6 rounded-lg bg-gray-700 text-white text-xs font-bold flex items-center justify-center flex-shrink-0 mt-0.5">
          {rank}
        </span>
        ...
        <div>
          <div className="border-t border-gray-100 divide-y divide-gray-50">
            {group.items.map((item, i) => (
              <div key={i} className="px-4 py-3 flex items-start gap-3 hover:bg-blue-50 transition-colors">
                <div className="flex-1 min-w-0">
